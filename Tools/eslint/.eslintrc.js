	...
	rules: {
		...
		'import/order': [2, {
			...
			pathGroups: [{
				...
				group: 'internal',
				pattern: '{utils,components,routes,hooks,mocks,App,steps,styles,icons,propTypes}/**/*',
			}],
		...
		'padding-line-between-statements': ['error', {
			blankLine: 'always',
			prev: '*',
			next: ['block-like', 'break', 'const', 'continue', 'function', 'let', 'return', 'switch', 'var'],
		}, {
			blankLine: 'always',
		...
		'react/sort-comp': [2, {
			order: ['static-variables', 'lifecycle', 'instance-variables', 'instance-methods', 'render'],
		}],
